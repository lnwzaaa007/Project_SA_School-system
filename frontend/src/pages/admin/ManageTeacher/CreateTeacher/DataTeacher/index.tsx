...
const ManageTeacher = () => {
  ...
  return (
    <div >
      <BackButton />
        <div style={{justifyContent: "center",boxShadow: "0 4px 12px rgba(0,0,0,0.1)", padding: '24px', background : "linear-gradient(to left, #83b1ffff, #ffffffff)", minHeight: '80vh', maxWidth: '75%' ,borderRadius: "32px" ,marginLeft : "13%"}} >
          <h1>ข้อมูลทั่วไป</h1>
          <Row gutter={[16, 12]}>
            <Col xs={24} md={12}>
